...
> **Status**: v0.0.4 is a bridge verification release. The extension
...
> run a task while streaming daemon events into an Output Channel. The real
> chat panel, diff viewer, and approval UI ship in v0.1.0.

...
function iconSvg(kind: string): string {
  ...
  switch (kind) {
    ...
    case 'todos':
      return `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="2.5" y="2.8" width="11" height="10.4" rx="1.5"/><path d="M5 6h6"/><path d="M5 8.5h6"/><path d="M5 11h3"/><path d="M3.8 6l.8.8 1.4-1.6"/></svg>`;
    case 'context-top':
    ...
    case 'mcp-add':
      return `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="2.5" width="10" height="4" rx="1.2"/><rect x="3" y="9.5" width="10" height="4" rx="1.2"/><path d="M8 6.5v3"/><path d="M8 10v4"/><path d="M6 12h4"/></svg>`;
    case 'mcp-test':
      return `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="2.5" width="10" height="4" rx="1.2"/><rect x="3" y="9.5" width="10" height="4" rx="1.2"/><path d="M8 6.5v3"/><path d="M5.5 11.5l1.4 1.4 3.6-3.6"/></svg>`;
    case 'mcp-remove':
      return `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="2.5" width="10" height="4" rx="1.2"/><rect x="3" y="9.5" width="10" height="4" rx="1.2"/><path d="M8 6.5v3"/><path d="M5.5 11.5h5"/></svg>`;
    case 'note-add':

...
- ✅ `@file` auto-mention — `peridot-tui::at_picker` 모듈 + slash-picker 패턴, VS Code composer parity
...
- ✅ 파일 첨부 sidebar artifact — daemon attachment metadata를 VS Code compact card로 렌더링하고 open/copy action 제공
